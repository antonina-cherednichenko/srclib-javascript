...
var pathVisitor = walk.make({
    ...
    Function: function(node, scopeInfo, c, identNode, rootNode) {
        ...
        if (identNode) {
            ...
            //save function definitions for possible further import and usage in jsx
            fnDefinitions[identNode] = {path: newScope};
 ...
 *
 * @param {string} fnName
 * @returns {DunctionDefinition} fn definition for given function
 */
module.exports.getFunction = function(fnName) {
    return fnDefinitions[fnName];
};
